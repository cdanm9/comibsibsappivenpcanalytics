		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsibsappivenpcanalytics-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappivenpcanalytics-display": {
								"semanticObject": "comibsibsappivenpcanalytics",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappivenpcanalytics",
									"url": sap.ui.require.toUrl("com/ibs/ibsappivenpcanalytics")
								}
							}
						}
					}
