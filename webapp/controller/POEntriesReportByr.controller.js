sap.ui.define([
    ...
    var num = 0;
    var count1;
	return Controller.extend("com.ibs.ibsappivenpcanalytics.controller.POEntriesReportByr", {
		formatter: formatter,
		onInit: function () {
		...
		handleValueHelpPONo: function (oEvent) {
            ...
            if (!this._valueHelpDialog) {
                this._valueHelpDialog = sap.ui.xmlfragment("com.ibs.ibsappivenpcanalytics.view.fragments.PoNumber",this);
