...
//     return Controller.extend("com.ibs.ibsappivenpcanalytics.controller.Master", {
//         onInit: function () {
...
sap.ui.define([
	...
	return Controller.extend("com.ibs.ibsappivenpcanalytics.controller.Master", {
	// return Controller.extend("com.ibs.ibsappivenpcanalytics.controller.POEntries", {
        formatter: formatter,
			onInit: function () {
			var that = this;
            debugger
		...
		handleRouteMatched: function (oEvent) {
			...
			that.getOwnerComponent().getService("ShellUIService").then(function (oShellService) {
				oShellService.setBackNavigation(function () {
					if (com.ibs.ibsappivenpcanalytics.ind2 === "X") {
