sap.ui.define([
	...
	return Controller.extend("com.ibs.ibsappivenpcanalytics.controller.SAConfirm", {
        formatter: formatter,
		onInit: function () {
		...
		onQuanPress: function (e) {
			...
			var that = this;
			if (!this.QuantFrag) {
				this.QuantFrag = sap.ui.xmlfragment("com.ibs.ibsappivenpcanalytics.view.fragments.SAReqQtyFrag", this);
