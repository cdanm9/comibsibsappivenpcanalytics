sap.ui.define([
	...
	"sap/ui/model/Sorter",
	"sap/m/MessageBox",
	"com/ibs/ibsappivenpcanalytics/model/formatterInvCreation",
	...
	return Controller.extend("com.ibs.ibsappivenpcanalytics.controller.Invoice_Master", {
		formatter: formatter,
		...
		onSelectionChange: function (oEvent) {
			...
			if (sKey === "Open") {
				...
				com.ibs.ibsappivenpcanalytics.oSelObject = oObj;
