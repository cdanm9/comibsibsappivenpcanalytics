sap.ui.define([
	...
	var viewModel = null;
	var selectedItem;
	return Controller.extend("com.ibs.ibsappivenpcanalytics.controller.SESPODetails", {
        formatter: formatter,
		onInit: function () {
		...
		_onObjectMatched: function (oEvent) {
			...
			context.oSelObject = com.ibs.ibsappivenpcanalytics.oSelObject;
				...
				return MessageBox.show("Please enter Posted Qty",{
					...
					if (!context._saveFragment) {
						context._saveFragment = sap.ui.xmlfragment(
							"com.ibs.ibsappivenpcanalytics.view.fragments.saveFragment",
							context
						);
				...
				if (data[i].code === "SES/001") {
					...
					if (!this.eAction) {
						this.eAction = sap.ui.xmlfragment(
							"com.ibs.ibsappivenpcanalytics.view.fragments.errorHandleSES",
							this
						);
			...
			if(iItemsLength === 0) {
				...
				if (!this.dAction) {
					this.dAction = sap.ui.xmlfragment(
						"com.ibs.ibsappivenpcanalytics.view.fragments.deleteFragment",
						this
					);
