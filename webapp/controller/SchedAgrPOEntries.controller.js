sap.ui.define([
	...
	return Controller.extend("com.ibs.ibsappivenpcanalytics.controller.SchedAgrPOEntries", {
        formatter: formatter,
		onInit: function () {
		...
		_getLoginDetails: function () {
			...
			//comment code before deploying start
			sLoginId = '8300894';
			sLoginType = 'partner';  
			that._user();  
			that.readData();
			// comment code before deploying end
